...
<div class="flood-meter" role="img" aria-label="AI-generated pull request volume on GitHub: 17 million per month by March 2026, a 325 percent increase from September 2025, while maintainer numbers stayed flat.">
  <div class="flood-meter__headline">
    <span>17M</span>
    <strong>AI-generated pull requests per month on GitHub (March 2026)</strong>
  </div>
  ...
  <div class="flood-stat flood-stat--amber">
    <strong>~4.5%</strong>
    <span>of all public GitHub commits from Claude Code alone</span>
  </div>
  <div class="flood-stat flood-stat--blue">
    <strong>36M</strong>
    <span>new developers joined GitHub in 2025</span>
  </div>
  <div class="flood-stat flood-stat--green">
    <strong>Flat</strong>
    <span>number of people taking on maintainer or ownership roles</span>
  </div>
  <div class="flood-meter__footer">More contributors, fewer stewards. The review queue grows; the capacity to process it does not.</div>
</div>
```
...
**"A denial-of-service attack on human attention."**<br>
GitHub's own 2026 open source report described the pattern.
:::

::: {style="background-color: #e3f2fd; padding: 16px; border-radius: 18px; margin-bottom: 14px; font-size: 0.78em;"}
**1 in 10 AI PRs is legitimate**<br>
Xavier Portilla Edo (Voiceflow) estimated 90% of AI-generated pull requests are noise.
:::

::: {style="background-color: #fff3e0; padding: 16px; border-radius: 18px; font-size: 0.76em;"}
**1.7x more issues**<br>
AI-generated PRs carry 1.7x more problems than human-written ones (CodeRabbit, 2026).
:::
...
::: {style="text-align: center; font-size: 0.44em; margin-top: 0.6em; color: #666;"}
Sources: [`GitHub` AI Agent Problem](https://www.danilchenko.dev/posts/2026-04-11-github-ai-agents-pull-requests/) · [The New Stack](https://thenewstack.io/ai-generated-code-crisis/) · [CodeRabbit](https://www.coderabbit.ai/blog/ai-is-burning-out-the-people-who-keep-open-source-alive)
:::
...
::: {style="background-color: #ffebee; padding: 16px; border-radius: 18px; margin-bottom: 14px; font-size: 0.8em;"}
**`curl` killed its bug bounty**<br>
After six years and 78 real CVEs fixed, AI-generated reports made the program unsustainable.
:::
...
In January 2026 alone, 20% of submissions were AI-generated. Only 5% of all reports turned out to be valid.
:::

::: {style="background-color: #e8f5e9; padding: 16px; border-radius: 18px; font-size: 0.76em;"}
**Then it reopened.**<br>
One month later, AI model quality had improved enough that `curl` returned to HackerOne. The floor moved — but so did the ceiling.
:::
...
::: {style="background-color: #ffebee; padding: 16px; border-radius: 18px; margin-bottom: 14px; font-size: 0.8em;"}
**`Jazzband` is shutting down**<br>
After 10 years maintaining 80+ Python packages, the cooperative announced its wind-down in March 2026.
:::

::: {style="background-color: #e3f2fd; padding: 16px; border-radius: 18px; margin-bottom: 14px; font-size: 0.76em;"}
**Open membership became the vulnerability**<br>
AI-generated spam PRs and issues made shared push access untenable. The model was designed for a world where the worst case was an accidental merge.
:::

::: {style="background-color: #fff3e0; padding: 16px; border-radius: 18px; font-size: 0.74em;"}
**Packages scatter, continuity breaks**<br>
`django-debug-toolbar` and others migrated to Django Commons. Non-Django packages must find new homes or go unmaintained.
:::
...
<div class="github-stress" role="img" aria-label="GitHub reported record acceleration in pull requests merged, commits, and new repositories per month. That activity flows into shared forge services where April 2026 incidents affected Copilot agents, search, Actions, and webhooks.">
  ...
  <div class="platform-stress__response">
    <strong>Response: projects leave, citing AI-driven strain</strong>
    <span>Ghostty left after AI contributions forced its vouch system. Zig banned AI-generated contributions and migrated to Codeberg. Gentoo mirrored for independence.</span>
  </div>
</div>
```
...
Automated account creation and coordinated engagement are cheaper with LLM tooling. He et al. found 6M suspected fake stars across 18K+ repos.
:::

::: {style="background-color: #fff3e0; padding: 16px; border-radius: 18px; font-size: 0.74em;"}
Stars feed discovery, rankings, and early funding attention. Once the signal can be bought, every passive trust metric needs an audit trail.
:::
...
::: {style="background-color: #f8f9fa; border-left: 4px solid #007bff; padding: 10px 12px; font-size: 0.58em; margin-top: 0.65em; color: #444;"}
**Broader trend:** ReversingLabs reports a **73%** increase in malicious OSS package detections and a **451%** surge in malicious npm packages in 2025. AI-driven attackers accounted for an **89%** increase in supply chain attacks.
:::
...
**AI code looks original, but you can't trace its sources.**<br>
A generated patch can pass review without revealing that it may be based on someone else's copyrighted work.
:::

::: {style="background-color: #e3f2fd; padding: 16px; border-radius: 18px; margin-bottom: 14px; font-size: 0.84em;"}
**Rewriting is not the same as writing from scratch.**<br>
When AI recreates functionality from existing code, the original licence terms may still apply — even if no line was copied verbatim.
:::

::: {style="background-color: #fff3e0; padding: 16px; border-radius: 18px; font-size: 0.84em;"}
Maintainers respond by requiring contributors to disclose AI use, prove where code came from, or banning AI-generated patches outright.
:::
...
The EU Cyber Resilience Act requires mandatory vulnerability reporting. The deadline is weeks away. Most of the open-source community is not ready.

:::

::: {style="background-color: #e3f2fd; padding: 16px; border-radius: 18px; margin-bottom: 14px; font-size: 0.84em;"}
**New category: "open-source software steward"**<br>
Foundations and entities that publish FOSS in a business context must document a cybersecurity policy, notify authorities of exploited vulnerabilities, and promote disclosure.
:::

::: {style="background-color: #fff3e0; padding: 16px; border-radius: 18px; font-size: 0.82em;"}
**Commercial vendors carry full liability**<br>
Companies that ship FOSS components in their products are responsible under the CRA — whether they maintain those components or not.
:::
...
```{=html}
<div class="cost-stack" role="img" aria-label="Impact map showing how synthetic contribution volume shifts costs onto junior developers, maintainers, projects, and the broader movement.">
  <div class="cost-stack__driver">
    <strong>Synthetic volume</strong>
    <span>pollutes the review well and pushes costs downstream</span>
  </div>
...
After shutting down in February, `curl` reopened on HackerOne in March 2026 — AI report quality had improved enough to make the program viable again.
...
`Ghostty` accepted transparent AI-assisted reports that helped fix four real crashes. The contributor came to Discord as a human first.
