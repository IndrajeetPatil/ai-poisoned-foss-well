...
<div class="flood-meter" role="img" aria-label="AI-generated pull request volume on GitHub: 17 million per month by March 2026, a 325 percent increase from September 2025, while maintainer numbers stayed flat.">
  ...
  <div class="flood-meter__footer">"A denial-of-service attack on human attention." — GitHub's 2026 open source report</div>
</div>
```
...
**Only 1 in 10 AI PRs is legitimate.** AI-generated PRs carry 1.7x more issues than human-written ones (CodeRabbit, 2026).
:::

::: {style="background-color: #fff3e0; padding: 14px; border-radius: 18px; font-size: 0.72em;"}
**Projects are leaving.** Ghostty, Zig, and Gentoo moved or mirrored away from GitHub, citing AI-driven contribution strain.
:::
...
Sources: [`GitHub` AI Agent Problem](https://www.danilchenko.dev/posts/2026-04-11-github-ai-agents-pull-requests/) · [The New Stack](https://thenewstack.io/ai-generated-code-crisis/) · [CodeRabbit](https://www.coderabbit.ai/blog/ai-is-burning-out-the-people-who-keep-open-source-alive) · [`GitHub` availability report](https://github.blog/news-insights/company-news/an-update-on-github-availability/) · [`Ghostty`](https://mitchellh.com/writing/ghostty-leaving-github) · [`Zig`](https://ziglang.org/news/migrating-from-github-to-codeberg/)
:::
