...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; align-items: start;">
  <figure style="margin: 0;">
    <img src="media/evidence/ghostty-leaving-github.png" class="artifact" alt="Screenshot of Mitchell Hashimoto's Ghostty Is Leaving GitHub post" style="width: 100%; height: 205px; object-fit: cover; object-position: top center;">
    <figcaption style="font-size: 0.46em; color: #666; margin-top: 5px;">Ghostty: leaving GitHub</figcaption>
  </figure>
  <figure style="margin: 0;">
    <img src="media/evidence/zig-codeberg-migration.png" class="artifact" alt="Screenshot of Zig's Migrating from GitHub to Codeberg post" style="width: 100%; height: 205px; object-fit: cover; object-position: top center;">
    <figcaption style="font-size: 0.46em; color: #666; margin-top: 5px;">Zig: GitHub to Codeberg</figcaption>
  </figure>
  <figure style="margin: 0;">
    <img src="media/evidence/gentoo-codeberg-planet.png" class="artifact" alt="Screenshot of Planet Gentoo mentioning Goodbye Github, welcome Codeberg" style="width: 100%; height: 205px; object-fit: cover; object-position: center center;">
    <figcaption style="font-size: 0.46em; color: #666; margin-top: 5px;">Gentoo: Codeberg mirror</figcaption>
  </figure>
  <div style="background-color: #e3f2fd; padding: 13px; border-radius: 18px; font-size: 0.68em; min-height: 205px; display: flex; align-items: center;">
