...
**January 2026**<br>
**75%** of the engineering team lost their jobs.<br>
Traffic down about **40%** from early 2023.<br>
Revenue down close to **80%**.
:::

::: {style="background-color: #e3f2fd; padding: 12px; border-radius: 18px; font-size: 0.7em;"}
AI can answer from the free core while bypassing the monetisation layer.
:::
...
![](media/evidence/tailwind-business-model.png){.artifact width="520" height="318" fig-alt="Screenshot of Tailwind CSS sponsorship page asking companies to support the future of Tailwind CSS"}
