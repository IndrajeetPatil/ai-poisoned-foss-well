...
::: {style=”background-color: #e3f2fd; padding: 14px; border-radius: 18px; font-size: 0.78em;”}
GitHub CTO apologised publicly (April 29, 2026): designed for 10× scale, discovered they need **30×**. Platform pivoted to **”Availability First”** — pausing new features to stabilise the foundation. Former GitHub CEO Thomas Dohmke had already called it: the platform *”was never designed for the era of AI in the first place.”*
:::
...
::: {style=”background-color: #fff3e0; padding: 14px; border-radius: 18px; margin-bottom: 14px; font-size: 0.86em;”}
**Zig → Codeberg (November 2025)**<br>
GitHub Actions “vibe-scheduling” rendered CI unreliable; Microsoft's persistent AI integrations conflicted with Zig's strict no-AI policy. The GitHub repo was made read-only.
:::

::: {style=”background-color: #e8f5e9; padding: 14px; border-radius: 18px; font-size: 0.82em;”}
**Ghostty announces departure (April 28, 2026)**<br>
Mitchell Hashimoto kept a daily journal — nearly every day had an outage mark. *”This is no longer a place for serious work if it just blocks you out for hours per day, every day.”*
:::
...
::: {style=”text-align: center; font-size: 0.5em; margin-top: 0.6em; color: #666;”}
Sources: [Kyle Daigle on X (Apr. 4, 2026)](https://x.com/kdaigle/status/2040164759836778878) · [GitHub Blog: An update on availability (Apr. 29, 2026)](https://github.blog/news-insights/company-news/an-update-on-github-availability/) · [Zig: Migrating from GitHub to Codeberg](https://ziglang.org/news/migrating-from-github-to-codeberg/) · [Hashimoto: Ghostty leaving GitHub (Apr. 28, 2026)](https://mitchellh.com/writing/ghostty-leaving-github) · [TechCrunch: Former GitHub CEO on Entire (Feb. 10, 2026)](https://techcrunch.com/2026/02/10/former-github-ceo-raises-record-60m-dev-tool-seed-round-at-300m-valuation/)
:::
