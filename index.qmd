...
::: {.fragment style="background-color: #e8f5e9; padding: 14px; border-radius: 18px; margin-bottom: 10px; font-size: 0.72em;"}
**Trust** lets contributors begin with a presumption of good faith.
:::

::: {.fragment style="background-color: #ffebee; padding: 14px; border-radius: 18px; font-size: 0.72em;"}
...
::: {.fragment style="background-color: #ffebee; padding: 16px; border-radius: 18px; font-size: 0.78em;"}
**After:** AI spam made open membership a liability. Non-Django packages must find new homes or go unmaintained — the model has no successor.
:::
...
::: {.fragment style="background-color: #e3f2fd; padding: 16px; border-radius: 18px; margin-bottom: 14px; font-size: 0.84em;"}
...
::: {.fragment style="background-color: #fff3e0; padding: 16px; border-radius: 18px; font-size: 0.84em;"}
...
::: {.fragment style="display: flex; gap: 12px; margin-top: 10px;"}
...
::: {.fragment style="background-color: #fff3e0; padding: 16px; border-radius: 18px; font-size: 0.82em;"}
...
::: {.fragment style="background-color: #e3f2fd; padding: 16px; border-radius: 18px; margin-bottom: 14px; font-size: 0.82em;"}
...
::: {.fragment style="background-color: #e8f5e9; padding: 16px; border-radius: 18px; margin-bottom: 12px; font-size: 0.88em;"}
...
::: {.fragment style="background-color: #fff3e0; padding: 16px; border-radius: 18px; font-size: 0.86em;"}
