...
![](media/illustrations/extraction-without-reciprocity.jpg){.illustration width="640" height="360" fig-alt="Generated scientific flow diagram showing a broad open-source commons feeding a model and commercial product pipeline, with only a thin return flow back to maintainers"}
...
![](media/illustrations/package-hallucination-chain.jpg){.illustration width="640" height="360" fig-alt="Generated scientific attack-chain diagram showing a hallucinated package node becoming a registered poisoned dependency and flowing into developer and production environments"}
...
```{=html}
<img src="media/evidence/github-april-availability-report.png" class="artifact" alt="Screenshot of GitHub's April 2026 availability report" style="width: 100%; height: 212px; object-fit: cover; object-position: top center;">
