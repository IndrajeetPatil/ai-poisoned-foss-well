...
```{=html}
<div class="platform-stress" role="img" aria-label="AI-accelerated GitHub activity flows into shared forge services. April 2026 incidents affected Copilot agent sessions, search, Actions, and webhooks, creating pressure that pushes projects toward mirrors and alternative forges.">
  <div class="platform-stress__inputs">
    <span>AI-accelerated activity</span>
    <strong>More PRs, commits, repos, agent sessions</strong>
  </div>
  <div class="platform-stress__arrow" aria-hidden="true">-&gt;</div>
  <div class="platform-stress__forge">
    <strong>Default FOSS forge</strong>
...
```{=html}
<div class="well-guardrails" role="img" aria-label="Three guardrails keep the FOSS well drinkable: review time, provenance, and commons repair.">
  <div class="guardrail guardrail--review">
    <strong>Protect review time</strong>
    <span>Disclose AI use</span>
    <span>Close synthetic drive-bys fast</span>
    <span>Make contributors own follow-up</span>
  </div>
  <div class="guardrail guardrail--provenance">
    <strong>Protect provenance</strong>
    <span>Require human accountability</span>
    <span>Treat unknown origin as risk</span>
    <span>Reject clean-room evasions</span>
  </div>
  <div class="guardrail guardrail--commons">
    <strong>Protect the commons</strong>
    <span>Verify dependencies</span>
    <span>Fund maintainers upstream</span>
    <span>Keep a real path in for people</span>
  </div>
  <div class="well-guardrails__basin">
    <span>drinkable FOSS well</span>
  </div>
</div>
```
