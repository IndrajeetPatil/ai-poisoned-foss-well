...
![](media/illustrations/foss-social-system.jpg){.illustration width="630" height="355" fig-alt="Generated illustration of an open-source commons as a stone well fed by review labour, trust, and apprenticeship, with a synthetic digital current disturbing the system"}
...
**Apprenticeship** is how future maintainers usually enter.
:::
...
::: {style="background-color: #fff3e0; padding: 14px; border-radius: 18px; margin-bottom: 12px; font-size: 0.76em;"}
...
::: {style="background-color: #e3f2fd; padding: 14px; border-radius: 18px; margin-bottom: 12px; font-size: 0.72em;"}
Healthy contribution returns context: docs, edge cases, review follow-up, and repeat contributors.
:::

::: {style="background-color: #e8f5e9; padding: 14px; border-radius: 18px; font-size: 0.68em;"}
...
![](media/illustrations/extraction-without-reciprocity.jpg){.illustration style="width: 100%; height: 430px; object-fit: cover; object-position: center center;" fig-alt="Generated scientific flow diagram showing a broad open-source commons feeding a model and commercial product pipeline, with only a thin return flow back to maintainers"}
...
Sources: [Koren et al. (arXiv, 2026)](https://arxiv.org/abs/2601.15494) · [PC Gamer, 2026](https://www.pcgamer.com/software/ai/vibe-coding-kills-open-source-claims-new-paper-as-its-authors-lament-the-lack-of-human-attention-towards-oss-products/)
:::
...
**Reconstruction is not proof.**<br>
AI-generated code can recreate behavior from public code, docs, APIs, and old releases while hiding provenance and licence lineage.
:::
...
![](media/illustrations/community-adaptation-filters.jpg){.illustration width="640" height="360" fig-alt="Generated scientific filter diagram showing synthetic contribution volume passing through verification, policy, and human review layers before reaching a healthy open-source commons"}

:::

::: {.column width="38%"}

::: {style="background-color: #e8f5e9; padding: 14px; border-radius: 18px; margin-bottom: 10px; font-size: 0.7em;"}
**Technical filters**<br>
Provenance tooling, `SLSA`, `sigstore`, and license-aware automation.
:::

::: {style="background-color: #e3f2fd; padding: 14px; border-radius: 18px; margin-bottom: 10px; font-size: 0.7em;"}
**Policy filters**<br>
Disclosure templates, explicit bans on undisclosed AI code, and review gates.
:::

::: {style="background-color: #fff3e0; padding: 14px; border-radius: 18px; font-size: 0.68em;"}
**Human filters**<br>
Accountability stays with a person before code enters the commons.
:::
...
::: {style="background-color: #FFFBC1; padding: 18px; border-radius: 25px; text-align: center;"}
The open-source ecosystem is adapting toward a filtered equilibrium, not a simple return to the old default-open model.
:::
