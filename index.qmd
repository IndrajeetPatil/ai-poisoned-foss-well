...
::: {style=”background-color: #f8f9fa; border-left: 4px solid #007bff; padding: 12px; font-size: 0.6em; margin-top: 1em; color: #444;”}
**Note:** GitHub was never the *only* FOSS home, but it was the *best* one — free CI/CD, hosting, Sponsors, Pages, and unmatched community reach made it the default. These departures matter not because alternatives lack, but because the platform that made FOSS easiest is now buckling under the era it helped create.
:::
