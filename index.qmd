...
::: {.visually-hidden}
Newcomer to trusted maintainer is the normal contribution path: first issue, small PR, review, repeat contribution, then trust. The XZ Utils backdoor breaks that trust chain and pushes projects toward suspicion, fewer external contributions, and a weaker contributor pipeline.
:::
