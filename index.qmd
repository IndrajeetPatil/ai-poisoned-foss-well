...
```{=html}
<img src="media/evidence/github-availability.png" class="artifact" alt="Screenshot of GitHub's April 2026 availability update" style="width: 100%; height: 212px; object-fit: cover; object-position: top center;">

<div aria-label="GitHub platform scale statistics" style="display: grid; grid-template-columns: 1fr 1fr; gap: 9px; margin-top: 11px;">
  <div style="background-color: #fff3e0; padding: 9px 11px; border-radius: 14px; font-size: 0.55em; line-height: 1.18;">
    <strong style="font-size: 1.55em;">275M</strong><br>
    commits per week
  </div>
  <div style="background-color: #e8f5e9; padding: 9px 11px; border-radius: 14px; font-size: 0.55em; line-height: 1.18;">
    <strong style="font-size: 1.55em;">2.1B</strong><br>
...
[GitHub's own availability post](https://github.blog/news-insights/company-news/an-update-on-github-availability/) frames the problem as a platform-scale shock: agentic development turns every pull request into load on storage, CI, search, permissions, notifications, and APIs.
:::
