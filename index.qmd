...
![](media/evidence/well-hero.webp){.hero width="310" height="430" fig-alt="An old water well in a grassy field"}
...
Source code for these slides can be found [on `GitHub`](https://github.com/IndrajeetPatil/ai-poisoned-foss-well/){style="text-decoration: underline;"}.
:::
...
![](media/illustrations/foss-social-system.webp){.illustration width="630" height="355" fig-alt="Generated illustration of an open-source commons as a stone well fed by review labour, trust, and reciprocity, with a synthetic digital current disturbing the system"}
...
![](media/evidence/github-record-acceleration.webp){.artifact width="610" height="340" fig-alt="GitHub blog figure showing record acceleration of pull requests merged, commits, and new repositories per month"}
...
![](media/evidence/shambaugh-post.webp){.artifact width="620" height="500" fig-alt="Screenshot of Scott Shambaugh's post about an AI agent publishing a hit piece after a rejected pull request"}
...
![](media/evidence/package-hallucination-story.webp){.artifact width="610" height="382" fig-alt="Screenshot of the USENIX article about comprehensive analysis of package hallucinations in code-generating LLMs"}
...
![](media/evidence/litellm-bot-flood.webp){.artifact width="610" height="455" fig-alt="Screenshot of the LiteLLM security issue flooded with repetitive comments"}
...
![](media/evidence/tailwind-business-model.webp){.artifact width="562" height="348" fig-alt="Screenshot of Tailwind CSS sponsorship page asking companies to support the future of Tailwind CSS"}
...
```{=html}
<div style="background: #ffffff; border: 1px solid #e5e7eb; border-radius: 22px; padding: 10px; box-shadow: 0 18px 40px rgba(15, 23, 42, 0.1);">
  <img src="media/evidence/cal-com-closed-source.webp" class="artifact" alt="Screenshot of Cal.com blog post announcing a move to closed source" style="width: 100%; height: 410px; object-fit: contain; object-position: top center; border-radius: 16px;">
</div>
```
...
Sources: [Song et al. (arXiv, 2024)](https://arxiv.org/abs/2410.02091) · [`GitHub` Blog, 2026](https://github.blog/ai-and-ml/github-copilot/building-ai-powered-github-issue-triage-with-the-copilot-sdk/) · [Continue Blog, 2026](https://web.archive.org/web/20260416234220/https://blog.continue.dev/were-losing-open-contribution) · [Cybernews on curl and Mythos](https://cybernews.com/security/curl-bug-bounty-ai-security-reports-daniel-stenberg/)
:::
...
<div class="well-two-column">
  ...
  <div class="well-two-column__image">
    <img src="media/illustrations/well-guardrails.webp" class="illustration" alt="Generated editorial illustration of a protected stone FOSS well with three guardrail systems for review time, provenance, and commons stewardship">
  </div>
</div>
```
