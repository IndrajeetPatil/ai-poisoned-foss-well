...
## Economics {style="margin-top: 2.3em; text-align: center;"}

::: {style="text-align: center; font-size: 0.9em; color: #666; margin-top: 1.1em;"}
...
AI turns FOSS into a faster input for product teams while skipping the human loops that send value back upstream.
:::
...
## Tailwind and the business-model shock {style="font-size: 0.76em;"}

:::: {.columns}

::: {.column width="42%"}

::: {style="background-color: #fff3e0; padding: 14px; border-radius: 18px; margin-bottom: 10px;"}
**The old loop**<br>
Free framework.<br>
Docs traffic.<br>
...
::: {style="background-color: #ffebee; padding: 13px; border-radius: 18px; margin-bottom: 10px; font-size: 0.72em;"}
**January 2026**<br>
📈 Tailwind usage kept rising.<br>
📉 Docs traffic about **40%** lower than early 2023.<br>
📉 Revenue close to **80%** lower.<br>
👥 **75%** of the engineering team lost their jobs.
:::

::: {style="background-color: #e3f2fd; padding: 12px; border-radius: 18px; font-size: 0.7em;"}
The framework grew. The docs funnel shrank. The business model broke.
:::
...
![](media/evidence/tailwind-business-model.png){.artifact width="548" height="340" fig-alt="Screenshot of Tailwind CSS sponsorship page asking companies to support the future of Tailwind CSS"}
...
## Security {style="margin-top: 2.3em; text-align: center;"}
...
## Community {style="margin-top: 2.3em; text-align: center;"}
...
::: {style="font-size: 0.52em; color: #666; text-align: center; margin-top: 0.35em; margin-bottom: 0.8em;"}
Accessible summary: newcomer → first issue → small PR → review → repeat contributor → trusted maintainer. The XZ Utils backdoor breaks that trust chain and pushes projects toward suspicion, fewer external contributions, and a weaker contributor pipeline.
:::
...
Disclose AI usage.<br>
Treat unknown code origin and clean-room claims as risk.
